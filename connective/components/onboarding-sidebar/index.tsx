...
const OnboardingSidebar = () => {
  return (
    <div className="relative flex justify-end min-w-[550px] w-5/12 h-fill bg-[url('/assets/journey.svg')] bg-no-repeat bg-center bg-cover flex flex-col p-[60px] mr-0 gap-[90px] relative z-[5]">
      ...
      <div className="z-[1] bg-[#fff2f2]/[0.13] px-[40px] py-[24px] w-fit mx-auto mb-20 backdrop-blur-[35.5px] mix-blend-normal rounded-xl">
